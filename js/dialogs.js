'use strict';
/* CapConfirm / CapPrompt — replaces native dialogs (Tier 1 kill-list). */
(function () {
        ...
        '<div class="cap-dialog-backdrop" id="cap-confirm-backdrop" role="presentation">' +
          '<div class="cap-dialog-sheet" role="alertdialog" aria-modal="true" aria-labelledby="cap-confirm-title" aria-describedby="cap-confirm-body">' +
            ...
            '<div class="cap-dialog-actions">' +
              '<button type="button" class="btn-g" data-confirm="no">' + escapeHtml(cancelLabel) + '</button>' +
              '<button type="button" class="' + (destructive ? 'btn-d' : 'btn-p') + '" data-confirm="yes">' + escapeHtml(confirmLabel) + '</button>' +
            '</div>' +
          '</div>' +
        '</div>';
      ...
      root.innerHTML =
        '<div class="cap-dialog-backdrop" id="cap-prompt-backdrop" role="presentation">' +
          '<div class="cap-dialog-sheet" role="dialog" aria-modal="true" aria-labelledby="cap-prompt-title">' +
            ...
            '<div class="cap-dialog-actions">' +
              '<button type="button" class="btn-g" data-prompt="no">' + escapeHtml(cancelLabel) + '</button>' +
              '<button type="button" class="btn-p" data-prompt="yes">' + escapeHtml(confirmLabel) + '</button>' +
            '</div>' +
          '</div>' +
        '</div>';
